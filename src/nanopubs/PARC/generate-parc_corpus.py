...
def main():
    ...
    annotation = open("./results/parc_annotation_corpus.trig", "w+")
    annotation_template = open("./templates/parc-annotation-corpus.trig", "r")
    ...
    text = open("./results/parc_text_corpus.trig", "w+")
    text_template = open("./templates/parc-text-corpus.trig", "r")
